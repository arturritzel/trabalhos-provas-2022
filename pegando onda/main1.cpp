...
//TESTE IF .WAV
    ...
    cout << "Tamanho do Subchunk2: " << cab.Subchunk2Size;
    ...
    ofstream outFile;
    outFile.open(arquivo_saida, ios::binary);
    ...
    for(int i = 0; i < tempo.total; i++){
        cout << "comecou a escrever: " << i << endl;
        int teste;
        cin >> teste;
        inFile.read((char *)&sample, cab.ByteRate);
        cout << sample << endl;
        cout << (char *)&sample << endl;
        outFile.write((char *)&sample, cab.ByteRate);
    }
